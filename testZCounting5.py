...
for run_i in range(0,len(fillRunlist)):
    ...
    #era split follows here:https://twiki.cern.ch/twiki/bin/viewauth/CMS/PdmV2018Analysis#DATA
    #to be implemented as data comes
#    if run<=302029:
#	era="C"
...
#        continue
    ...
    for chunk_i in range(0,len(LSchunks)):
        #if one want to use particular feature in some bin
        #if(chunk_i != 5):
        #    continue
